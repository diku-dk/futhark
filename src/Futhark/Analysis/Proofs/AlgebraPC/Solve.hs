...
findSpecialSymbolToElim :: (Expression e, Ord e) =>
    SoP Symbol -> AlgM e (Maybe (Symbol, Range Symbol))
...
getSumRange :: (Expression e, Ord e) =>
    Symbol -> AlgM e (Maybe (Symbol, Range Symbol))
...
getMonRange :: (Expression e, Ord e) =>
    Symbol -> AlgM e (Maybe (Symbol, Range Symbol))
getMonRange sym@(Mdf dir arr_nm idx1 idx2) = do
  ...
  let i1_m_i2 = int2SoP m .*. (idx1 .-. idx2)
      ...
      range = 
        ...
        else let (elm_lb, elm_ub) = (S.elemAt 0 elm_lbs, S.elemAt 0 elm_ubs)
...
getIdxRange :: (Expression e, Ord e) =>
    Symbol -> AlgM e (Maybe (Symbol, Range Symbol))
