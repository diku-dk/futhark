...
tests =
  [ ("tests/refinement/scalar.fut",
    ...
    ("tests/refinement/part2indicesL.fut",
     [ ("part2indicesL", [
        "∀i₆₄₃₀ ∈ ⊎k₆₄₃₃=iota m₆₁₉₇ [∑shp₆₂₀₉[0 : -1 + k₆₄₃₃], ..., ∑shp₆₂₀₉[0 : k₆₄₃₃]) .",
        "    | csL₆₂₁₉[i₆₄₃₀] && shp₆₂₀₉[k₆₄₃₃] == 0 ⇒  -1 + ∑shp₆₂₀₉[0 : -1 + k₆₄₃₃] + ∑⟦csL₆₂₁₉⟧[∑shp₆₂₀₉[0 : -1 + k₆₄₃₃] : i₆₄₃₀]",
        "    | ¬(csL₆₂₁₉[i₆₄₃₀]) && shp₆₂₀₉[k₆₄₃₃] == 0 ⇒  -1 + i₆₄₃₀ + -1*∑⟦csL₆₂₁₉⟧[∑shp₆₂₀₉[0 : -1 + k₆₄₃₃] : i₆₄₃₀]",
        "    | csL₆₂₁₉[i₆₄₃₀] && shp₆₂₀₉[k₆₄₃₃] /= 0 ⇒  -1 + ∑shp₆₂₀₉[0 : -1 + k₆₄₃₃] + ∑⟦csL₆₂₁₉⟧[∑shp₆₂₀₉[0 : -1 + k₆₄₃₃] : i₆₄₃₀]",
        "    | ¬(csL₆₂₁₉[i₆₄₃₀]) && shp₆₂₀₉[k₆₄₃₃] /= 0 ⇒  i₆₄₃₀ + ∑⟦csL₆₂₁₉⟧[1 + i₆₄₃₀ : -1 + ∑shp₆₂₀₉[0 : k₆₄₃₃]]"
       ])
     ])
  ]
