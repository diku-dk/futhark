...
mapOnLambda :: Monad m =>
               Mapper flore tlore m -> Lambda flore -> m (Lambda tlore)
...
walkOnType tv (Acc ts) = mapM_ (walkOnShape tv . snd) ts
