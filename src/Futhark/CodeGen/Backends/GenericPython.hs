...
compileFunc (fname, Imp.Function _ _ _ outputs inputs body _ _) = do
...
prepareEntry (fname, Imp.Function _ _ _ outputs inputs _ results args) = do
...
callEntryFun pre_timing entry@(fname, Imp.Function _ _ _ _ _ _ _ decl_args) = do
