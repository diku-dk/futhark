...
genWGSLStm (Op (ImpGPU.Atomic _ _)) =
  pure $
    WGSL.Comment "TODO: Unimplemented statement"
genWGSLStm (Op (ImpGPU.Barrier _)) =
  pure $
    WGSL.Comment "TODO: Unimplemented statement"
genWGSLStm (Op (ImpGPU.MemFence _)) =
  pure $
    WGSL.Comment "TODO: Unimplemented statement"
genWGSLStm (Op (ImpGPU.SharedAlloc _ _)) =
  pure $
    WGSL.Comment "TODO: Unimplemented statement"
genWGSLStm (Op (ImpGPU.ErrorSync _)) =
  pure $
    WGSL.Comment "TODO: Unimplemented statement"
...
wgslBinOp (UDiv Int8 _) = call2 "udiv_i8"
wgslBinOp (UDiv Int16 _) = call2 "udiv_i16"
wgslBinOp (UDiv Int32 _) = call2 "udiv_i32"
wgslBinOp (UDiv Int64 _) = WGSL.BinOpExp "<TODO: unimplemented binop>"
wgslBinOp (UDivUp Int8 _) = call2 "udiv_up_i8"
wgslBinOp (UDivUp Int16 _) = call2 "udiv_up_i16"
wgslBinOp (UDivUp Int32 _) = call2 "udiv_up_i32"
wgslBinOp (UDivUp Int64 _) = WGSL.BinOpExp "<TODO: unimplemented binop>"
wgslBinOp (SDiv Int8 _) = call2 "sdiv_i8"
wgslBinOp (SDiv Int16 _) = call2 "sdiv_i16"
wgslBinOp (SDiv Int32 _) = call2 "sdiv_i32"
wgslBinOp (SDiv Int64 _) = WGSL.BinOpExp "<TODO: unimplemented binop>"
wgslBinOp (SDivUp Int8 _) = call2 "sdiv_up_i8"
wgslBinOp (SDivUp Int16 _) = call2 "sdiv_up_i16"
...
wgslBinOp (UMod Int8 _) = call2 "umod_i8"
wgslBinOp (UMod Int16 _) = call2 "umod_i16"
wgslBinOp (UMod Int32 _) = call2 "umod_i32"
wgslBinOp (UMod Int64 _) = WGSL.BinOpExp "<TODO: unimplemented binop>"
wgslBinOp (SMod Int8 _) = call2 "smod_i8"
wgslBinOp (SMod Int16 _) = call2 "smod_i16"
...
genConstAndBuiltinDecls = do
  ...
  let (constMap, constDecls, constInits) =
        unzip3 $
