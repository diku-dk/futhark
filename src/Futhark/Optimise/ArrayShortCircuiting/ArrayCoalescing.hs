...
shortCircuitGPUMem _ _ _ (EnsureRowMajor _) _ bu_env = pure bu_env
...
shortCircuitMCMem _ _ _ (EnsureRowMajor _) _ bu_env = pure bu_env
...
computeScalarTableMemOp _ _ (EnsureRowMajor _) = pure mempty
