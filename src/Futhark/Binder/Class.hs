...
class (Attributes lore,
  ...
  mkLetNames :: (MonadFreshNames m, HasTypeEnv (NameType lore) m) =>
...
mkLetNames' :: (Bindable lore, MonadFreshNames m, HasTypeEnv (NameType lore) m) =>
