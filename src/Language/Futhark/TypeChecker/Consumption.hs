...
combineAliases (Scalar (Refinement t1 e1)) t2 =
  Scalar (Refinement (combineAliases t1 t2) e1)
combineAliases t1 (Scalar (Refinement t2 e2)) =
  Scalar (Refinement (combineAliases t1 t2) e2)
