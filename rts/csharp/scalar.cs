...
static sbyte or8(sbyte x, sbyte y){ return (sbyte) (x | y); }
static short or16(short x, short y){ return (short) (x | y); }
static int or32(int x, int y){ return x | y; }
static long or64(long x, long y){ return x | y;}

static sbyte xor8(sbyte x, sbyte y){ return (sbyte) (x ^ y); }
static short xor16(short x, short y){ return (short) (x ^ y); }
static int xor32(int x, int y){ return x ^ y; }
static long xor64(long x, long y){ return x ^ y;}

static sbyte and8(sbyte x, sbyte y){ return (sbyte) (x & y); }
static short and16(short x, short y){ return (short) (x & y); }
static int and32(int x, int y){ return x & y; }
static long and64(long x, long y){ return x & y;}

static sbyte shl8(sbyte x, sbyte y){ return (sbyte) (x << y); }
static short shl16(short x, short y){ return (short) (x << y); }
static int shl32(int x, int y){ return x << y; }
static long shl64(long x, long y){ return x << Convert.ToInt32(y); }

static sbyte ashr8(sbyte x, sbyte y){ return (sbyte) (x >> y); }
static short ashr16(short x, short y){ return (short) (x >> y); }
