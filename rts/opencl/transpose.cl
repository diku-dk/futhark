...
__kernel void map_transpose_4b(__global uint32_t *dst_mem,
                               int64_t dst_offset,
...
__kernel void map_transpose_4b_low_height(__global uint32_t *dst_mem,
                                          int64_t dst_offset,
                                          __global uint32_t *src_mem,
                                          int64_t src_offset,
                                          int32_t num_arrays,
...
__attribute__((reqd_work_group_size(TR_BLOCK_DIM, TR_BLOCK_DIM, 1)))
__kernel void map_transpose_4b_low_width(__global uint32_t *dst_mem,
                                         int64_t dst_offset,
                                         __global uint32_t *src_mem,
                                         int64_t src_offset,
                                         int32_t num_arrays,
...
__kernel void map_transpose_4b_small(__global uint32_t *dst_mem,
                                     int64_t dst_offset,
                                     __global uint32_t *src_mem,
                                     int64_t src_offset,
                                     int32_t num_arrays,
...
__attribute__((reqd_work_group_size(TR_BLOCK_DIM*2, TR_TILE_DIM/TR_ELEMS_PER_THREAD, 1)))
__kernel void map_transpose_4b_large(__global uint32_t *dst_mem,
                                     int64_t dst_offset,
                                     __global uint32_t *src_mem,
                                     int64_t src_offset,
                                     int64_t num_arrays,
