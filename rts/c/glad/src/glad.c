...
/*
    ...
    Commandline:
        --profile="core" --api="gl=4.3" --generator="c" --spec="gl" --extensions="GL_ARB_compute_variable_group_size"
    Online:
        https://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gl%3D4.3&extensions=GL_ARB_compute_variable_group_size
*/

#include <stdio.h>
#include <stdlib.h>
#include <string.h>
// This line must always be excluded.
//#include <glad/glad.h>
