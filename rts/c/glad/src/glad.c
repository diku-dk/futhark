...
// NOTE: Remember to remove `#include <glad/glad.h>` from this
// file if it is updated.

/*

    OpenGL loader generated by glad 0.1.33.
    ...
    Commandline:
        --profile="core" --api="gl=4.5" --generator="c" --spec="gl" --extensions="GL_ARB_compute_variable_group_size,GL_ARB_gpu_shader_fp64,GL_ARB_gpu_shader_int64"
    Online:
        https://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gl%3D4.5&extensions=GL_ARB_compute_variable_group_size&extensions=GL_ARB_gpu_shader_fp64&extensions=GL_ARB_gpu_shader_int64
*/
