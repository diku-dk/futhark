...
def i8_to_string (x: i8) : []u8 =
  if x >= 0i8
  then pos_u64_to_string (u64.i8 x)
  else if x == -128i8
  then "-128"
  else "-" ++ pos_u64_to_string (u64.i8 (-x))

def i16_to_string (x: i16) : []u8 =
  if x >= 0i16
  then pos_u64_to_string (u64.i16 x)
  else if x == -32768i16
  then "-32768"
  else "-" ++ pos_u64_to_string (u64.i16 (-x))
...
def i64_to_string (x: i64) : []u8 =
  if x >= 0i64
  then pos_u64_to_string (u64.i64 x)
  else if x == -9223372036854775808i64
  then "-9223372036854775808"
  else "-" ++ pos_u64_to_string (u64.i64 (-x))
