...
entry gen_record_sums (size: i64) (_seed: u64) : record =
  let s = replicate size (i32.i64 size)
  let a = replicate size (i32.i64 size * -10)
  in {s, a}
...
entry gen_record_sums_fail (size: i64) (_seed: u64) : record =
