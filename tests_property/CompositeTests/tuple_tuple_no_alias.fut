...
entry gen_simple (size: i64) (seed: u64) : ((i32, i32), (i32, i32)) =
...
entry gen_simple_fail (size: i64) (seed: u64) : ((i32, i32), (i32, i32)) =
  let rng0 = rng_engine.rng_from_seed [i32.u64 seed]
  let (_, v) = rand_i32.rand (- i32.i64 size, i32.i64 size) rng0
  in ((v, v + 1), (v + 1, v + 1))
...
entry shrink_simple ((a: i32, b: i32), (c: i32, d: i32)) (random: u64) : ((i32, i32), (i32, i32)) =
  let tactic = random % 6
  in if tactic == 0
     then let x0' = step0 a
          let y0' = step0 c
