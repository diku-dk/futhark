...
module rand_u16 = uniform_int_distribution u16 rng_engine
module shrink_u16 = integerlShrinkers u16

entry gen_simple (size: i64) (seed: u64) : u16 =
...
entry shrink_simple (x: u16) (random: u64) : u16 =
