...
import Futhark.SoP.Monad (addEquiv, addRange, mkRange, addProperty)
...
import Futhark.Analysis.Proofs.Monad (IndexFnM, debugPrintAlgEnv, debugOn, debugPrettyM, runIndexFnM)
