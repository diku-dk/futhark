...
$\forall v\in\aliases{e}.p$ -- in this case, the set elements are all
variables mentioned anywhere in the sharing information.

Aliasing is reflexive -- if $v\in\aliases{e}$, then $\exists
v'\in\aliases{e}\Rightarrow v\in\aliases{v}$.  Aliasing is mostly
intuitive, but here's a few definitions describing how sharing is
