...
L0 is a mostly-monomorphic, statically typed, strictly evaluated,
...
The syntax of the first-order fragment of L0 can be seen in figure
...
of L0.  The first is the let-with construct for updating parts of
arrays:
...
tryFuseSOAC lam_vars res (out_ids, soac) = do   
  ...
  let kers_cap=map (\mymath{\backslash}k->S.intersection (inplace k) all_used) 
                   to_fuse_kers
