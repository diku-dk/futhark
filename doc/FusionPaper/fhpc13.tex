...
form of {\em uniqueness attributes} inspired by Clean and Rust, as
well as aliasing analysis.  We extend the syntax for array types to
permit a prefix asterisk, as seen in figure
\ref{fig:uniqueness-types}, denoting a unique array.
...
tuple-transformation flattens all tuples (i.e, {\tt (x,(y,z))} becomes
...
\begin{figure}[bt]
\begin{center}
\includegraphics[width=0.6\columnwidth]{Figures/pipeline}
\end{center}
