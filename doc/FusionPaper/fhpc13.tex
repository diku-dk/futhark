...
\begin{itemize}
    ...
    \item  the let-binding of a {\sc soac} statement then both environment 
            variables are updated with the new bindings, the body of the {\sc soac} 
            lambda is processed, and {\tt tryFuseSOAC}, described in 
            Section~\ref{sec:FusingOnce} 
            will attempt to fuse if possible the current {\sc soac}. 
