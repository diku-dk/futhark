module Generated.AllFutBenchmarks.Pbbs.Ray.Bvh (benchmarkDataList) where
...
benchmarkDataList =
  [ ( [ "t_8322_8328_8326" ~ "[]t_8322_8328_8326_8322_8329_8327",
    ...
    ( [ "{max: {x: f32, y: f32, z: f32}, min: {x: f32, y: f32, z: f32}}" ~ "t_8321",
      ...
      M.empty,
      M.fromList [("kt_8320", (3, TyVarFree NoLoc Lifted)), ("t_8321", (3, TyVarRecord NoLoc (M.fromList [("min", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8320" 15084}) []))]))), ("kt_8322", (3, TyVarFree NoLoc Lifted)), ("t_8323", (3, TyVarRecord NoLoc (M.fromList [("x", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8322" 15086}) []))]))), ("kt_8324", (3, TyVarFree NoLoc Lifted)), ("t_8325", (3, TyVarRecord NoLoc (M.fromList [("min", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8324" 15088}) []))]))), ("kt_8326", (3, TyVarFree NoLoc Lifted)), ("t_8327", (3, TyVarRecord NoLoc (M.fromList [("x", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8326" 15090}) []))]))), ("kt_8321_8322", (3, TyVarFree NoLoc Lifted)), ("t_8321_8323", (3, TyVarRecord NoLoc (M.fromList [("min", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8321_8322" 15097}) []))]))), ("kt_8321_8324", (3, TyVarFree NoLoc Lifted)), ("t_8321_8325", (3, TyVarRecord NoLoc (M.fromList [("y", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8321_8324" 15099}) []))]))), ("kt_8321_8326", (3, TyVarFree NoLoc Lifted)), ("t_8321_8327", (3, TyVarRecord NoLoc (M.fromList [("min", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8321_8326" 15101}) []))]))), ("kt_8321_8328", (3, TyVarFree NoLoc Lifted)), ("t_8321_8329", (3, TyVarRecord NoLoc (M.fromList [("y", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8321_8328" 15103}) []))]))), ("kt_8322_8324", (3, TyVarFree NoLoc Lifted)), ("t_8322_8325", (3, TyVarRecord NoLoc (M.fromList [("min", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8322_8324" 15110}) []))]))), ("kt_8322_8326", (3, TyVarFree NoLoc Lifted)), ("t_8322_8327", (3, TyVarRecord NoLoc (M.fromList [("z", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8322_8326" 15112}) []))]))), ("kt_8322_8328", (3, TyVarFree NoLoc Lifted)), ("t_8322_8329", (3, TyVarRecord NoLoc (M.fromList [("min", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8322_8328" 15114}) []))]))), ("kt_8323_8320", (3, TyVarFree NoLoc Lifted)), ("t_8323_8321", (3, TyVarRecord NoLoc (M.fromList [("z", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8323_8320" 15116}) []))]))), ("t_8323_8328", (4, TyVarFree NoLoc Lifted)), ("kt_8323_8329", (5, TyVarFree NoLoc Lifted)), ("t_8324_8320", (5, TyVarRecord NoLoc (M.fromList [("max", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8323_8329" 15127}) []))]))), ("kt_8324_8321", (5, TyVarFree NoLoc Lifted)), ("t_8324_8322", (5, TyVarRecord NoLoc (M.fromList [("x", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8324_8321" 15129}) []))]))), ("kt_8324_8323", (5, TyVarFree NoLoc Lifted)), ("t_8324_8324", (5, TyVarRecord NoLoc (M.fromList [("max", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8324_8323" 15131}) []))]))), ("kt_8324_8325", (5, TyVarFree NoLoc Lifted)), ("t_8324_8326", (5, TyVarRecord NoLoc (M.fromList [("x", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8324_8325" 15133}) []))]))), ("kt_8325_8321", (5, TyVarFree NoLoc Lifted)), ("t_8325_8322", (5, TyVarRecord NoLoc (M.fromList [("max", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8325_8321" 15140}) []))]))), ("kt_8325_8323", (5, TyVarFree NoLoc Lifted)), ("t_8325_8324", (5, TyVarRecord NoLoc (M.fromList [("y", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8325_8323" 15142}) []))]))), ("kt_8325_8325", (5, TyVarFree NoLoc Lifted)), ("t_8325_8326", (5, TyVarRecord NoLoc (M.fromList [("max", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8325_8325" 15144}) []))]))), ("kt_8325_8327", (5, TyVarFree NoLoc Lifted)), ("t_8325_8328", (5, TyVarRecord NoLoc (M.fromList [("y", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8325_8327" 15146}) []))]))), ("kt_8326_8323", (5, TyVarFree NoLoc Lifted)), ("t_8326_8324", (5, TyVarRecord NoLoc (M.fromList [("max", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8326_8323" 15153}) []))]))), ("kt_8326_8325", (5, TyVarFree NoLoc Lifted)), ("t_8326_8326", (5, TyVarRecord NoLoc (M.fromList [("z", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8326_8325" 15155}) []))]))), ("kt_8326_8327", (5, TyVarFree NoLoc Lifted)), ("t_8326_8328", (5, TyVarRecord NoLoc (M.fromList [("max", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8326_8327" 15157}) []))]))), ("kt_8326_8329", (5, TyVarFree NoLoc Lifted)), ("t_8327_8320", (5, TyVarRecord NoLoc (M.fromList [("z", Scalar (TypeVar NoUniqueness (QualName {qualQuals = [], qualLeaf = VName "kt_8326_8329" 15159}) []))]))), ("t_8327_8327", (6, TyVarFree NoLoc Lifted))]
    ),
    ( [ "t_8320" ~ "t_8323",
        "num_8324" ~ "t_8323",
        "t_8323" ~ "f32",
