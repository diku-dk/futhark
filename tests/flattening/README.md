...
When working on the flattening pass, it may well be that some of the structure
...
Many of the tests here will use attributes to force flattening to go a certain
