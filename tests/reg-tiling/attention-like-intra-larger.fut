-- ==
-- compiled random input {[512][128][64]f16 [512][256][64][128]f16}
-- nobench compiled random input {[16][128][64]f16 [16][12][64][128]f16} auto output

-- compiled script input { (mk_attention_like_input 512i64 256i64 128i64 128i64 64i64) }
...
def mk_attention_like_input p q m n k : ([p][m][k]f16, [p][q][k][n]f16) =
