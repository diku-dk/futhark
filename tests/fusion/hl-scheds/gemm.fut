...
def gemm [M][N][Q] (A: [M][Q]real) (B: [Q][N]real) (D: [M][N]real) (alpha: real) (beta: real) : [M][N]real =
  let (m, Tm, Rm) = strip2 M
  let (n, Tn, Rn) = strip2 N
  let (q, Tq)     = strip1 Q
  let C = imap2 A D (\Arow Drow -> imap2 (transpose B) Drow (\Bcol d -> let c = padDotProd (q*Tq) 0 Arow Bcol in alpha*c + beta*d )) 
...
def main [M][N][Q] (A: [M][Q]real) (B: [Q][N]real) (D: [M][N]real) (alpha: real) (beta: real) : [M][N]real =
