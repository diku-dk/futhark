...
-- metadata is in units of the (non-scalar) element type, not scalars.  The value
...
--           [30i32, 31i32]]
--          [[5i32, 6i32], [10i32, 11i32], [20i32, 21i32], [30i32, 31i32]] }

def main (ks: []i64) (xs: [][]i32) =
  flatmap (\(k, x) -> (replicate k x, x)) (zip ks xs)
